    ...
    <section className='why-we-are-unique'>
      ...
      <div className='mt-5 container unique-details'>
        <div className="details-wrapper">
          <FontAwesomeIcon icon={faBriefcase} className="fa icon-1" />
        ...
        <div className="details-wrapper">
          <FontAwesomeIcon icon={faHandshake} className="fa icon-2" />
        ...
        <div className="details-wrapper">
          <FontAwesomeIcon icon={faBoxesStacked} className="fa icon-3" />
